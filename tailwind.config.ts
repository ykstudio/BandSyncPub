  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'primary-on-light': 'hsl(var(--primary-text-on-light))',
        secondary: {
        ...
        accent: {
          ...
          lightBg: 'hsl(var(--accent-light-solid-bg))',
        },
        destructive: {
      ...
      animation: {
        ...
        'metronome-pulse': 'metronome-pulse 1s infinite ease-in-out' // Default duration, will be overridden
      },
    },
  },
